...
fetchAllFriends();});});define("init",function(){});require.config({deps:['init']});define("bundle",function(){});}());joms_init_postbox=undefined;};if(typeof jQuery==='undefined'){throw new Error('Bootstrap\'s JavaScript requires jQuery')}
